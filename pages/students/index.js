...
import styles from '../../styles/StudentsIndex.module.css'
                ...
                <div key={i} className={styles.syllabusContainer} >
                    <span className={styles.syllabusCategory}>
                        ...
                        <div className={styles.syllabusCategoryText}>
                            ...
                            <span>{c.name} Learner Books</span>
                            {/* </Link> */}
                        ...
                        <div className={styles.homeTopContainer}>
                            <div className={styles.homeTopHolder}>
                                <div className={styles.indexTitle}>
                                    Curriculum eStudent Books
                                </div>
                                <p>This is Solomon Islands elearning flatform recently published by the Ministry of Education and Human Resource Development. This flatform hold all student books elearning content for ECE, Primary, Junior Secondary, Senior Secondary and TVET.</p>
                                <div className={styles.syllabusCategory}>{category()}</div>
                            </div>
                        </div>
                        <div className={styles.contentContainer}>
                            Student Books content space
                        </div>
                    </div>
                </div>
            </div>
